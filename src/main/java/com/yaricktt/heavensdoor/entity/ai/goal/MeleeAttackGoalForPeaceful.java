package com.yaricktt.heavensdoor.entity.ai.goal;
...
// code from https://github.com/Mrbysco/AngryMobs/blob/main/src/main/java/com/mrbysco/angrymobs/handler/goals/MobMeleeAttackGoal.java
public class MeleeAttackGoalForPeaceful extends Goal {
    ...
    public MeleeAttackGoalForPeaceful(MobEntity creature, double speedIn, boolean useLongMemory) {
